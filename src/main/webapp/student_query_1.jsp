        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">班级课程查询</h2>
                    <form id="login_in" action="student_query_1.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1">班级</label>
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryClassCourse(opt[0], text);
                %>
