        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">查询个人课表</h2>
                    <form id="login_in" action="student_query_5.jsp" method="post">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameterValues("radio1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryOwnCourse(opt[0], session.getAttribute("username").toString());
                %>
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center">授课时间</th>
