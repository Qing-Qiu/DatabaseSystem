        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">课程信息查询</h2>
                    <form id="login_in" action="admin_query_5.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1">课程号</label>
                            <label><input type="radio" name="radio1" value="2">课程名</label>
                            <label><input type="radio" name="radio1" value="3">授课教师</label>
                            <label><input type="radio" name="radio1" value="4" checked>全部</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryCourse(opt[0], text);
                %>
