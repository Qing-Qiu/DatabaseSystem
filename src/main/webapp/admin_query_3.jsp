        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form id="login_in" action="admin_query_3.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1">专业</label>
                            <label><input type="radio" name="radio1" value="2">年级</label>
                            <label><input type="radio" name="radio1" value="3">班级</label>
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryClass(opt[0], text);
                %>
