        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">教师信息查询</h2>
                    <form id="login_in" action="admin_query_2.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1">工号</label>
                            <label><input type="radio" name="radio1" value="2">姓名</label>
                            <label><input type="radio" name="radio1" value="3" checked>全部</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryTeacher(opt[0], text);
                %>
                <table class="table table-striped">
                    ...
                    <tr>
                        <td><%= record.getTeacherId() %>
                        </td>
                        <td><%= record.getTeacherName() %>
                        </td>
                        <td><%= record.getTeacherSex() %>
                        </td>
                        <td><%= record.getTeacherAge() %>
                        </td>
                        <td><%= record.getTeacherTitle() %>
                        </td>
                        <td><%= record.getTeacherPhone() %>
                        </td>
                    </tr>
                    <% } %>
                    </tbody>
