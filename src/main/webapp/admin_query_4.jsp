        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">专业信息查询</h2>
                    <form id="login_in" action="admin_query_4.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1">专业名称</label>
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryMajor(opt[0], text);
                %>
