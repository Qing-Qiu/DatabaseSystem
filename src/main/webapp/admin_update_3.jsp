        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">课程信息修改</h2>
                    <form id="login_in" action="admin_update_3.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1" checked>学期</label>
                            <label><input type="radio" name="radio1" value="2">详情</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        boolean flag = dao.updateCourse(opt[0], username, text);
