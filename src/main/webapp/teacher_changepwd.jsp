            ...
            <ul class="nav navbar-nav navbar-left">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="teacher_query_1.jsp">授课学生信息</a></li>
                        <li><a href="teacher_query_2.jsp">个人授课信息</a></li>
                        <li><a href="teacher_query_3.jsp">教师课程信息</a></li>
                        <li><a href="teacher_query_4.jsp">个人基本信息</a></li>
                        <li><a href="teacher_query_5.jsp">课程平均分查询</a></li>
                        <li><a href="teacher_query_6.jsp">学生成绩查询</a></li>
                        <li><a href="teacher_query_7.jsp">学生名次查询</a></li>
                    </ul>
                </li>
                <li class="dropdown">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <h2 class="text-center">教师修改密码</h2>
                    <form id="login_in" action="teacher_changepwd.jsp" method="post">
