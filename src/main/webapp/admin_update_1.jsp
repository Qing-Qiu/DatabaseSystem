        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form id="login_in" action="admin_update_1.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1" checked>户籍地</label>
                            <label><input type="radio" name="radio1" value="2">年龄</label>
                            <label><input type="radio" name="radio1" value="3">总学分</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        boolean flag = dao.updateStudent(opt[0], username, text);
