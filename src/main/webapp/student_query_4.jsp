        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">已修学分查询</h2>
                    <form id="login_in" action="student_query_4.jsp" method="post">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameterValues("radio1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryCredit(opt[0], session.getAttribute("username").toString());
                        boolean flag = false;
                %>
                <%
