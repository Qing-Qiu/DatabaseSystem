        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="text-center">学生成绩名次查询</h2>
                    <form id="login_in" action="teacher_query_3.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1">课程名</label>
                            <label><input type="radio" name="radio1" value="2">课程具体编号</label>
                            <label><input type="radio" name="radio1" value="3" checked>测试用</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("text1") != null) {
                        ...
                        ArrayList<Record> records = dao.queryScoreRank(opt[0], text);
                %>
