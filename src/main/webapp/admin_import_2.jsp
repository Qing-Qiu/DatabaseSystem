        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <h2 class="text-center">新生登记</h2>
                    <form id="login_in" action="admin_import_2.jsp" method="post">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("id") != null) {
                        ...
                        record.setStudentId(request.getParameter("id"));
                        record.setMajorId(request.getParameter("major_id"));
                        record.setGrade(request.getParameter("grade"));
                        record.setClassName(request.getParameter("class_name"));
                        record.setStudentName(request.getParameter("name"));
                        record.setStudentSex(request.getParameterValues("sex")[0]);
                        record.setStudentAge(request.getParameter("age"));
                        record.setStudentRegion(request.getParameter("region"));
                        record.setStudentCredits(request.getParameter("credits"));
                        boolean flag = dao.registerNew("2", record);
