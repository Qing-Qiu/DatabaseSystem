        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <h2 class="text-center">师生密码重置</h2>
                    <form id="login_in" action="admin_resetpwd.jsp" method="post">
                        <div class="form-group">
                            <label><input type="radio" name="radio1" value="1" checked>学生</label>
                            <label><input type="radio" name="radio1" value="2">教师</label>
                        </div>
                        <div class="form-group">
            ...
            <div class="row text-center">
                <%
                    if (request.getParameter("username") != null) {
                        ...
                        String[] role = request.getParameterValues("radio1");
                        AdminDao dao = new AdminDaoImpl();
                        boolean flag = dao.resetPwd(role[0], username);
